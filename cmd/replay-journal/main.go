...
//	--journal <file>      a text journal exported via yolo-journalctl — a
...
func main() {
	...
	journalPath := fs.String("journal", "", "read a text journal (yolo-journalctl export) instead of a JSONL capture — lossy, best-effort")
